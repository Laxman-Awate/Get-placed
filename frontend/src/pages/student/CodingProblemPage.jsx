...
export function CodingProblemPage() {
  ...
  if (!problem) return <div className="empty-companies"><h2>Problem not found.</h2><p>Choose a problem from the coding library.</p><Link className="button" href="/coding/problems">Back to problems</Link></div>;
