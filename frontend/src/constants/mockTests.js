const questions = [
 ...
 {id:'q3',section:'Verbal Ability',topic:'Vocabulary',difficulty:'Easy',question:'Choose the closest meaning of ΓÇ£conciseΓÇ¥.',options:['Clear and brief','Highly detailed','Difficult to understand','Repeated often'],correctAnswer:0,explanation:'Concise means expressing something clearly in few words.'},
 ...
 {id:'q6',section:'Verbal Ability',topic:'Grammar',difficulty:'Medium',question:'Choose the grammatically correct sentence.',options:['She go to class.','She going to class.','She goes to class.','She gone to class.'],correctAnswer:2,explanation:'The singular subject ΓÇ£sheΓÇ¥ takes ΓÇ£goesΓÇ¥ in the present tense.'},
];
