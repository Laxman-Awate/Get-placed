...
export const COMPANY_MODULES = [
  { id: 'overview', title: 'Company Overview', description: 'Understand the process and commonly reported preparation areas.', icon: '◇', free: true, progress: 100, action: 'Explore overview' },
  { id: 'aptitude', title: 'Aptitude Preparation', description: 'Quantitative, logical, verbal and data interpretation practice.', icon: '◎', free: false, progress: 0, action: 'Unlock module' },
  { id: 'dsa', title: 'Company-specific DSA', description: 'Curated patterns and problems for this preparation focus.', icon: '⌘', free: false, progress: 0, action: 'Unlock module' },
  { id: 'technical', title: 'Technical Preparation', description: 'OOP, DBMS, OS, networks, SQL and programming fundamentals.', icon: '▦', free: false, progress: 0, action: 'Unlock module' },
  ...
  { id: 'mock-tests', title: 'Company Mock Tests', description: 'Practice company-oriented test simulations.', icon: '◉', free: false, progress: 0, action: 'View tests' },
  { id: 'interview', title: 'Interview Preparation', description: 'Prepare for technical, behavioral, HR and project discussions.', icon: '✦', free: false, progress: 0, action: 'Explore module' },
];
